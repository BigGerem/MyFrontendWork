...
body.setAttribute('style', 'width: 100%; margin: 0; background: black;');
ball.append(result);
content.setAttribute('style', 'display: flex; width: 60%; height: 100%; margin: 0 auto; align-items: center; flex-direction: column;');
header.setAttribute('style', 'font-size: 50px; color: #DDA0DD; margin: 20px 0;');
